    ...
    <section ref={sectionRef} id="контакты" className="py-20 px-4 bg-card relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className={`bg-background border-primary/20 p-8 transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <Card className={`bg-background border-primary/20 p-8 flex flex-col justify-center transition-opacity duration-700 delay-200 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
