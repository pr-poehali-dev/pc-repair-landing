...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E27] text-white">
      ...
      <section id="для бизнеса" className="py-20 px-4 bg-[#0D1235] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0A0E27] via-transparent to-transparent h-32 z-10"></div>
        ...
        <div className="container mx-auto max-w-5xl relative z-20" ref={corporateRef}>
          <h2 className={`text-4xl md:text-5xl font-bold text-center mb-6 transition-all duration-700 ${corporateInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Для <span className="text-[#00D9FF] neon-glow">корпоративных</span> клиентов
          </h2>
          <p className={`text-center text-xl text-gray-300 mb-12 transition-all duration-700 delay-100 ${corporateInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Профессиональное обслуживание компьютерной техники для бизнеса
          </p>
          
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className={`bg-[#0A0E27] border-[#00D9FF]/20 p-8 transition-all duration-700 delay-200 ${corporateInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-lg bg-[#00D9FF]/10 flex items-center justify-center">
                  <Icon name="FileText" size={32} className="text-[#00D9FF]" />
                </div>
                <h3 className="text-2xl font-bold text-[#00D9FF]">Работа по договору</h3>
              </div>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-3">
                  <Icon name="Check" size={20} className="text-[#00D9FF] mt-1 flex-shrink-0" />
            ...
            <Card className={`bg-[#0A0E27] border-[#00D9FF]/20 p-8 transition-all duration-700 delay-300 ${corporateInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-lg bg-[#00D9FF]/10 flex items-center justify-center">
                  <Icon name="Briefcase" size={32} className="text-[#00D9FF]" />
                </div>
                <h3 className="text-2xl font-bold text-[#00D9FF]">Услуги для бизнеса</h3>
              </div>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-3">
                  <Icon name="Check" size={20} className="text-[#00D9FF] mt-1 flex-shrink-0" />
          ...
          <Card className={`bg-gradient-to-r from-[#00D9FF]/10 to-[#0A0E27] border-[#00D9FF]/30 p-8 transition-all duration-700 delay-400 ${corporateInView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-lg bg-[#00D9FF]/20 flex items-center justify-center flex-shrink-0">
                  <Icon name="Handshake" size={32} className="text-[#00D9FF]" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold mb-2">Специальные условия</h3>
                  <p className="text-gray-300">Индивидуальные тарифы для постоянных клиентов</p>
                </div>
              </div>
              <Button
                onClick={() => scrollToSection('контакты')}
                className="bg-transparent hover:bg-[#00D9FF] text-[#00D9FF] hover:text-[#0A0E27] border-2 border-[#00D9FF] font-bold px-8 py-6 rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,217,255,0.5)] whitespace-nowrap"
              >
                Обсудить условия
              </Button>
            </div>
